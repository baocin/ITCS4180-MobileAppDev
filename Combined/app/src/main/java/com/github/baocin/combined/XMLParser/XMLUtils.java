package com.github.baocin.combined.XMLParser;
...
public class XMLUtils {
    ...
    public static class XMLParser {
        ...
        public static String parseCurrentTemperature (InputStream in) throws XmlPullParserException, IOException {
                ...
                switch (event) {
                    ...
                    case XmlPullParser.START_TAG:
                        ...
                        if (parser.getName().equals("temp_f")) {
                            ...
                            temp.append(parser.nextText().trim());
                        }
                        break;
                    ...
                    case XmlPullParser.END_TAG:
                        ...
                        if (parser.getName().equals("temp_f")) {
                            Log.d("Current Temperature", temp.toString());
    ...
    public static ArrayList<Weather> parseForecast(InputStream i) {
